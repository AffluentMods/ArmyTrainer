...
public class MessageUtil {
    ...
    public static boolean sendMessage(User u, String msg1, boolean presuffix) {
        if (presuffix) msg1 = "You received a message from an **Admin** of **ArmyTrainer**:\n\n`" + msg1 +
                              "`\n\nTo respond, please visit the official discord server of ArmyTrainer.\nClick the " +
                              "Discord-Invite link at `a.invite` to join.";
